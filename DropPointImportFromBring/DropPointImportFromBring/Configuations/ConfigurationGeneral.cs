...
namespace DropPointImportFromBring.Configuations
{
    /// <summary>
    ...
    public static class ConfigurationGeneral
    {
        ...
        public static String DropPointWebserviceUrl
        {
            get
            {

                return ConfigurationManager.AppSettings["DropPointWebserviceUrl"];
            }
        }
